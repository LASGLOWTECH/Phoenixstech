      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6 text-center md:text-left">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-gray-900 tracking-tight">
            ...
            with Us and Make a Difference
          </h2>

          <p className="text-base sm:text-lg md:text-xl text-gray-600">
            Join a team that values innovation, collaboration, and personal growth.
            Explore opportunities to grow your career while making a real impact.
          </p>
          ...
          <div className="flex flex-wrap justify-center md:justify-start items-center gap-3 pt-2">
            ...
            <FaCircleUser className="w-8 h-8 text-Primarycolor" />
            <span className="text-sm font-medium text-gray-700">300+ Talents</span>
          </div>
        </div>
