          ...
          >
            ...
            <div className="p-5 text-center md:text-left">
              ...
              <div className="flex justify-centerbottom-2 md:justify-start space-x-4 mt-4">
                ...
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer"><FaFacebookF className="text-white group-hover:text-Secondarycolor text-xl transition-colors duration-300 cursor-pointer" /></a>

                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">          <FaTwitter className="text-white group-hover:text-Secondarycolor text-xl transition-colors duration-300 cursor-pointer" /></a>
