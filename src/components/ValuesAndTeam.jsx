...
const ValuesAndTeamSection = () => {
            ...
            <div className='grid grid-cols-1 lg:grid-cols-4 relative items-start gap-8'>
                ...
                <div className='bg-white  md:mt-[30px] p-6 h-[450px] -full rounded-md shadow-md z-10 lg:col-span-2'>
                    <div className="flex mb-4 items-center justify-left flex-row ">
                        ...
                        <p className="text-sm text-orange-500 ">Values</p>
                    </div>
  ...
  <div className="flex items-start space-x-3">
    ...
    <div>
      ...
      <p className="text-sm text-gray-600 leading-relaxed text-left">
        We tailor every solution to fit your unique needs and long-term goals.
      </p>
    </div>
  </div>
  ...
  <div className="flex items-start space-x-3">
    ...
    <div>
      ...
      <p className="text-sm text-gray-600 leading-relaxed text-left">
        Reliable, high-standard service delivery—every time, across all project touchpoints.
      </p>
    </div>
  </div>
  ...
  <div className="flex items-start space-x-3">
    ...
    <div>
      ...
      <p className="text-sm text-gray-600 leading-relaxed text-left">
        We focus on building strong, lasting relationships, not just completing tasks.
      </p>
    </div>
  </div>
</div>
                ...
                <div className="md:ml-[-100px] mt-[60px]  md:mt-[-60px] rounded-lg shadow-xl overflow-hidden lg:col-span-2 h-full lg:h-auto"  data-aos="fade-up" data-aos-duration="1000">
                    <img src={Image4} alt="Diverse Team" className="w-full h-full object-cover" />
                </div>
            </div>
        </div>
    );
