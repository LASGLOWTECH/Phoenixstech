...
const pl= {
  ...
  "Driving Business": "Napędzanie biznesu",
  "Excellence": "Doskonałość",
  "Through Multilingual Business Support": "Poprzez wielojęzyczne wsparcie biznesowe",
  "Empowering businesses across industries with tailored customer service solutions that build stronger relationships, boost satisfaction, and scale success globally and efficiently.": "Wzmacnianie firm z różnych branż dzięki dostosowanym rozwiązaniom obsługi klienta, które budują silniejsze relacje, zwiększają satysfakcję i skalują sukces na całym świecie efektywnie.",
  ...
  "for Multilingual Business Support": "dla wielojęzycznego wsparcia biznesu",
  "Phoenixs Tech provides multilingual customer service support across various industries, including finance, retail, e-commerce, and more. We enhance business–customer relationships.": "Phoenixs Tech zapewnia wielojęzyczne wsparcie klienta w różnych branżach, w tym w finansach, handlu detalicznym, e-commerce i innych. Wzmacniamy relacje biznes-klient.",
  "Years": "Lata",
  "Experience": "Doświadczenie",
  "Experts": "Ekspertów",
  "Satisfied Clients": "Zadowolonych Klientów",
  
  
  //  business solutions
  "Our Services": "Nasze Usługi",
  "Transform Your Business": "Przekształć swoją firmę",
  "with Expert Solutions": "z ekspertowymi rozwiązaniami",
  "Tailored customer support to boost satisfaction and drive growth.": "Dopasowane wsparcie klienta, które zwiększa satysfakcję i napędza rozwój.",

  // services

"Inbound & Outbound Call Center": "Centrum obsługi połączeń przychodzących i wychodzących",
  "Efficient call services to boost customer engagement and retention.": "Efektywne usługi telefoniczne zwiększające zaangażowanie i lojalność klientów.",
  "Live Chat & Email Support": "Wsparcie na czacie na żywo i e-mail",
  "Instant support through live chat and email for quick resolutions.": "Natychmiastowe wsparcie przez czat na żywo i e-mail dla szybkiego rozwiązywania problemów.",
  "Technical Support & IT Helpdesk": "Wsparcie techniczne i pomoc IT",
  "Expert IT troubleshooting and support to keep systems running.": "Ekspercka pomoc i rozwiązywanie problemów IT, aby systemy działały bez zakłóceń.",
  "Multilingual Support": "Wsparcie wielojęzyczne",
  "Seamless communication in multiple languages to reach a global audience.": "Płynna komunikacja w wielu językach, aby dotrzeć do globalnej publiczności.",



  // why us
  "Why Work With Us?": "Dlaczego warto z nami pracować?",
  "Partner with Us": "Współpracuj z nami",
  "for Exceptional Results": "dla wyjątkowych rezultatów",
  "Expert Teams": "Eksperckie zespoły",
  "Work with skilled professionals who bring deep industry knowledge and specialized expertise to every project.": "Współpracuj z wykwalifikowanymi specjalistami, którzy wnoszą dogłębną wiedzę branżową i specjalistyczne umiejętności do każdego projektu.",
  "Tailored Solutions": "Dopasowane rozwiązania",
  "Customized solutions crafted to meet your specific business needs, ensuring enhanced efficiency, innovation, and a competitive edge.": "Dostosowane rozwiązania stworzone, aby spełnić specyficzne potrzeby Twojej firmy, zapewniając zwiększoną wydajność, innowacyjność i przewagę konkurencyjną.",
  "Proven Track Record": "Udokumentowane sukcesy",
  "End-to-End Support": "Wsparcie kompleksowe",
  "Enjoy seamless support throughout every stage, from project inception to post-implementation, ensuring your long-term success.": "Ciesz się bezproblemowym wsparciem na każdym etapie, od rozpoczęcia projektu po jego wdrożenie, zapewniając długoterminowy sukces.",
  "Diverse Team": "Zróżnicowany zespół",

  // services sections 

  "Empowering Your Business with": "Wzmacniamy Twój biznes dzięki",
  "Advanced Technologies": "Zaawansowanym technologiom",
  "We provide tailored solutions across data analytics, software development, UX design, and more to drive innovation and success.": "Oferujemy dopasowane rozwiązania w zakresie analizy danych, tworzenia oprogramowania, projektowania UX i nie tylko, aby napędzać innowacje i sukces.",
  
  "Data Analytics Excellence": "Ekspertyza w analizie danych",
  "We assemble a team of specialists to conduct thorough analysis and deliver customized data-driven solutions tailored to your needs.": "Tworzymy zespół specjalistów, którzy przeprowadzają dokładne analizy i dostarczają spersonalizowane rozwiązania oparte na danych, dopasowane do Twoich potrzeb.",
  
  "UX & Business Analysis": "Analiza UX i biznesowa",
  "Expert services in UX design, UI/Usability, graphics, and advanced business systems analysis to align with your goals.": "Eksperckie usługi w zakresie projektowania UX, UI/użyteczności, grafiki oraz zaawansowanej analizy systemów biznesowych, dostosowane do Twoich celów.",
  
  "Project Management": "Zarządzanie projektami",
  "Experienced team handles complex projects and delivers seamless solutions across various project models.": "Doświadczony zespół zarządza złożonymi projektami i dostarcza płynne rozwiązania w różnych modelach projektowych.",
  
  "Software Development": "Tworzenie oprogramowania",
  "Specialists in advanced IT solutions for web, desktop, and mobile platforms with a focus on performance and innovation.": "Specjaliści w zaawansowanych rozwiązaniach IT dla platform webowych, desktopowych i mobilnych, skupiający się na wydajności i innowacjach.",
  
  "Quality Assurance": "Zapewnienie jakości",
  "Skilled consultants manage testing and QA processes across technologies to ensure reliable solutions.": "Wykwalifikowani konsultanci zarządzają procesami testowania i zapewnienia jakości w różnych technologiach, aby zapewnić niezawodne rozwiązania.",
  
  "Admin & Security": "Administracja i bezpieczeństwo",
  "We execute Microsoft Technologies projects focusing on optimization, automation, and security.": "Realizujemy projekty oparte na technologiach Microsoft z naciskiem na optymalizację, automatyzację i bezpieczeństwo.",
  
  "Banking IT Solutions": "Rozwiązania IT dla sektora bankowego",
  "We support IT projects in the banking sector, offering both on-site and remote system support.": "Wspieramy projekty IT w sektorze bankowym, oferując wsparcie systemowe zarówno na miejscu, jak i zdalnie.",
  
  "IT Engineering Solutions": "Rozwiązania inżynierii IT",
  "We deliver IT solutions for industries like automotive, rail, and oil & gas, with training programs.": "Dostarczamy rozwiązania IT dla przemysłu motoryzacyjnego, kolejowego oraz sektora naftowego i gazowego, wraz z programami szkoleniowymi.",
  
  "ERP Implementation": "Wdrożenie ERP",
  "Optimize business operations through ERP, supporting owners with project workflow and data security.": "Optymalizuj operacje biznesowe dzięki ERP, wspierając właścicieli w zarządzaniu przepływem pracy oraz bezpieczeństwem danych.",
  
  "Innovation & R&D": "Innowacje i badania",
  "We build innovative IT solutions and develop tools that improve the efficiency of daily operations.": "Tworzymy innowacyjne rozwiązania IT oraz rozwijamy narzędzia poprawiające efektywność codziennych operacji.",
// careers
"careers": {
    "sectionLabel": "Kariera",
    "heading": "Dołącz do naszego zespołu i buduj przyszłość",
    "description": "W naszej firmie wierzymy w tworzenie kultury innowacji, współpracy i ciągłego rozwoju. Oferujemy dynamiczne środowisko, w którym Twoje pomysły są cenione, a kariera może się rozwijać. Dołącz do zespołu pasjonatów, którzy dążą do osiągania wyjątkowych rezultatów. Niezależnie od tego, czy chcesz rozwijać swoje umiejętności, czy wywierać wpływ w swojej dziedzinie, odkryj ekscytujące możliwości kariery i zrób kolejny krok w swojej zawodowej podróży razem z nami.",
    "buttonText": "Poznaj oferty pracy",
    "imageAlt": "zespół kariery",
  },



  // subscriptions
  "Get the latest updates and offers from us": "Otrzymuj najnowsze aktualizacje i oferty od nas",
  "Get the latest industry news, tips, and trends straight to your inbox.": "Otrzymuj najnowsze wiadomości branżowe, wskazówki i trendy prosto na swoją skrzynkę.",
  ...
  "Something went wrong. Please try again later.": "Coś poszło nie tak. Proszę spróbuj ponownie później.",
  "Something went wrong. Please try again.": "Coś poszło nie tak. Proszę spróbuj ponownie.",

// footer
"Ready to Take the": "Gotowy na",
  "Next Step?": "Następny krok?",
  "Let’s connect and explore how we can help you achieve your goals. Reach out to us today!": "Połączmy się i odkryjmy, jak możemy pomóc Ci osiągnąć Twoje cele. Skontaktuj się z nami już dziś!",
  "Contact Us": "Skontaktuj się z nami",
  ...
  "Careers": "Kariera",
  "Inbound & Outbound Call Center": "Centrum obsługi połączeń przychodzących i wychodzących",
  "Live Chat & Email Support": "Wsparcie przez czat na żywo i e-mail",
  "Technical Support & IT Helpdesk": "Wsparcie techniczne i pomoc IT",
  "Multilingual Support": "Wsparcie wielojęzyczne",
  "Industries": "Branże",
  "Automotive": "Motoryzacja",
  ...
  "Retail and E-Commerce": "Detal i e-commerce",
  "Banking and Financial Service": "Bankowość i usługi finansowe",
